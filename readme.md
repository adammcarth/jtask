# JTask [![Gem Version](http://img.shields.io/gem/v/jtask.svg)](https://rubygems.org/gems/jtask) [![Build Status](https://travis-ci.org/adammcarthur/jtask.svg)](https://travis-ci.org/adammcarthur/jtask)
